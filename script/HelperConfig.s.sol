...
contract HelperConfig is Script {
    ...
    struct NetworkConfig {
        address entryPoint;
        address account;
    } // Deployer/burner wallet address
    // Chain ID Constants
    ...
    address constant BURNER_WALLET = 0x9C0C59480D99d46bdb09A069d23689ECBDb9daE0; // Replace with your actual address​
...
vm.stopBroadcast();
           address accountToUse =  FOUNDRY_DEFAULT_WALLET;
   localNetworkConfig = NetworkConfig({entryPoint:address(entryPoint), account: accountToUse});
    return localNetworkConfig;
    }
